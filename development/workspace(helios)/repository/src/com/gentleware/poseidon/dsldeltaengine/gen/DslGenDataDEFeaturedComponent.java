...
public class DslGenDataDEFeaturedComponent extends AbstractDEComponent {

	private Map<String, Map<String, Deltas>> featuresOfType = new HashMap<String, Map<String, Deltas>>();

	public DslGenDataDEFeaturedComponent(EObject subject) {
		super(subject);
	}
	...
	public void initialiseDeltas() {
		addFeature(DslGenElementRoles.DATA, DslGenElementRoles.VARIABLE,
				((com.gentleware.poseidon.dsl.wsn.Data) getSubject())
						.getVariable(), featuresOfType);
	}

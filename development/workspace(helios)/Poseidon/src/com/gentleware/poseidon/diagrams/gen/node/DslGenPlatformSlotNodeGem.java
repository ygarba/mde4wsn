...
public class DslGenPlatformSlotNodeGem extends BaseNodeGem {

	public DslGenPlatformSlotNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenPlatformSlotNodeGem(EObject subject, DiagramFacet diagram,

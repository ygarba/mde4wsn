...
public class DslGenBatteryNodeGem extends BaseNodeGem {

	public DslGenBatteryNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenBatteryNodeGem(EObject subject, DiagramFacet diagram,

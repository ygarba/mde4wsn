...
public class DslGenRemoteTriggerActionNodeGem extends
		SeparateNameContainerNodeGem {

	public DslGenRemoteTriggerActionNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenRemoteTriggerActionNodeGem(EObject subject,
			DiagramFacet diagram, String figureId, Color initialFillColor,

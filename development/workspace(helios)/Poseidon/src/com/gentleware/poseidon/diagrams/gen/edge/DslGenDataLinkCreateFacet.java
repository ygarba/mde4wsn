...
import com.gentleware.poseidon.diagrams.gen.edge.DslGenDataLinkCreatorGem;
...
public abstract class DslGenDataLinkCreateFacet extends BaseArcCreateFacet {
	public static final String DEFAULT_FIGURE_NAME = "DataLink";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedDataLink";

	protected DslGenDataLinkCreatorGem creatorGem;

	public DslGenDataLinkCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenDataLinkCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(DiagramFacet diagram,
		...
		final EObject target = (EObject) points.getNode2().getFigureFacet()
				.getSubject();
		return factory.createDataLinkSemanticElement(source, target);
	}

	public String getFigureName() {
		return DslGenDataLinkCreatorGem.NAME;
	}
	...
	public void initSourcesAndTargets() {
		...
		targets.add(DslGenElementRoles.DATA);
	}

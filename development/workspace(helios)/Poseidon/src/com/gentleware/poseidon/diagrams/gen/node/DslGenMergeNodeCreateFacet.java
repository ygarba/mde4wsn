...
import com.gentleware.poseidon.diagrams.gen.node.DslGenMergeNodeCreatorGem;
...
public abstract class DslGenMergeNodeCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "MergeNode";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedMergeNode";

	protected DslGenMergeNodeCreatorGem creatorGem;

	public DslGenMergeNodeCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenMergeNodeCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createMergeNodeSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenMergeNodeCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.MERGENODE);
	}

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenActuatorCreatorGem;
...
public abstract class DslGenActuatorCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "Actuator";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedActuator";

	protected DslGenActuatorCreatorGem creatorGem;

	public DslGenActuatorCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenActuatorCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createActuatorSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenActuatorCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.ACTUATOR);
	}

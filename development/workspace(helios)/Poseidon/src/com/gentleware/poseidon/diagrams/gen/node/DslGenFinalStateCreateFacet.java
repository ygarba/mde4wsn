...
import com.gentleware.poseidon.diagrams.gen.node.DslGenFinalStateCreatorGem;
...
public abstract class DslGenFinalStateCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "FinalState";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedFinalState";

	protected DslGenFinalStateCreatorGem creatorGem;

	public DslGenFinalStateCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenFinalStateCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createFinalStateSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenFinalStateCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.FINALSTATE);
	}

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenBatteryCreatorGem;
...
public abstract class DslGenBatteryCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "Battery";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedBattery";

	protected DslGenBatteryCreatorGem creatorGem;

	public DslGenBatteryCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenBatteryCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createBatterySemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenBatteryCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.BATTERY);
	}

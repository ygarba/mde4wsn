...
import com.gentleware.poseidon.diagrams.gen.node.DslGenRuntimeCreatorGem;
...
public abstract class DslGenRuntimeCreateFacet extends
		CustomBaseNodeCreateFacet {
	public static final UDimension MINIMUM_SIZE = new UDimension(
			3.2 * ZGridLayer.DEFAULT_GRID_SPACING,
			2.3 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final UDimension DEFAULT_SIZE = new UDimension(
			3.2 * ZGridLayer.DEFAULT_GRID_SPACING,
			2.3 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final String DEFAULT_FIGURE_NAME = "Runtime";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedRuntime";

	protected DslGenRuntimeCreatorGem creatorGem;

	public DslGenRuntimeCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenRuntimeCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createRuntimeSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenRuntimeCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.RUNTIME);
	}

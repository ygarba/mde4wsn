...
import com.gentleware.poseidon.diagrams.gen.edge.DslGenSensingCreatorGem;
...
public abstract class DslGenSensingCreateFacet extends BaseArcCreateFacet {
	public static final String DEFAULT_FIGURE_NAME = "Sensing";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedSensing";

	protected DslGenSensingCreatorGem creatorGem;

	public DslGenSensingCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenSensingCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(DiagramFacet diagram,
		...
		final EObject target = (EObject) points.getNode2().getFigureFacet()
				.getSubject();
		return factory.createSensingSemanticElement(source, target);
	}

	public String getFigureName() {
		return DslGenSensingCreatorGem.NAME;
	}
	...
	public void initSourcesAndTargets() {
		...
		targets.add(DslGenElementRoles.SENSOR);
	}

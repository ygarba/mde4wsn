...
public class DslGenSensingActionNodeGem extends SeparateNameContainerNodeGem {

	public DslGenSensingActionNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenSensingActionNodeGem(EObject subject, DiagramFacet diagram,

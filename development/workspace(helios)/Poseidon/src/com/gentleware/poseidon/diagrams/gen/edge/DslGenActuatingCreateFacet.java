...
import com.gentleware.poseidon.diagrams.gen.edge.DslGenActuatingCreatorGem;
...
public abstract class DslGenActuatingCreateFacet extends BaseArcCreateFacet {
	public static final String DEFAULT_FIGURE_NAME = "Actuating";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedActuating";

	protected DslGenActuatingCreatorGem creatorGem;

	public DslGenActuatingCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenActuatingCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(DiagramFacet diagram,
		...
		final EObject target = (EObject) points.getNode2().getFigureFacet()
				.getSubject();
		return factory.createActuatingSemanticElement(source, target);
	}

	public String getFigureName() {
		return DslGenActuatingCreatorGem.NAME;
	}
	...
	public void initSourcesAndTargets() {
		...
		targets.add(DslGenElementRoles.ACTUATOR);
	}

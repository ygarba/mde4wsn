...
public class DslGenParametersNodeGem extends BaseNodeGem {

	public DslGenParametersNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenParametersNodeGem(EObject subject, DiagramFacet diagram,

...
import com.gentleware.poseidon.diagrams.gen.edge.DslGenMessagingCreatorGem;
...
public abstract class DslGenMessagingCreateFacet extends BaseArcCreateFacet {
	public static final String DEFAULT_FIGURE_NAME = "Messaging";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedMessaging";

	protected DslGenMessagingCreatorGem creatorGem;

	public DslGenMessagingCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenMessagingCreatorGem creatorGem) {
...
/*
	...
	public EObject createSemanticElement(DiagramFacet diagram,
		...
		final EObject target = (EObject) points.getNode2().getFigureFacet()
				.getSubject();
		return factory.createMessagingSemanticElement(source, target);
	}
*/
	public String getFigureName() {
		return DslGenMessagingCreatorGem.NAME;
	}
	...
	public void initSourcesAndTargets() {
		...
		targets.add(DslGenElementRoles.TASK);
	}

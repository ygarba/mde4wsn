...
import com.gentleware.poseidon.diagrams.gen.node.DslGenSensingActionCreatorGem;
...
public abstract class DslGenSensingActionCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "SensingAction";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedSensingAction";

	protected DslGenSensingActionCreatorGem creatorGem;

	public DslGenSensingActionCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenSensingActionCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createSensingActionSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenSensingActionCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.SENSINGACTION);
	}

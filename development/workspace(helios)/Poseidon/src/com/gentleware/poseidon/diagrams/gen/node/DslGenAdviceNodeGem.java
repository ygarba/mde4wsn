...
public class DslGenAdviceNodeGem extends BaseNodeGem {

	public DslGenAdviceNodeGem(Color initialFillColor, PersistentFigure figure,
			String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenAdviceNodeGem(EObject subject, DiagramFacet diagram,

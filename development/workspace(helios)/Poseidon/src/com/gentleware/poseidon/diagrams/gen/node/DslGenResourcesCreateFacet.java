...
import com.gentleware.poseidon.diagrams.gen.node.DslGenResourcesCreatorGem;
...
public abstract class DslGenResourcesCreateFacet extends
		CustomBaseNodeCreateFacet {
	public static final UDimension MINIMUM_SIZE = new UDimension(
			3.2 * ZGridLayer.DEFAULT_GRID_SPACING,
			3.3 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final UDimension DEFAULT_SIZE = new UDimension(
			3.2 * ZGridLayer.DEFAULT_GRID_SPACING,
			3.3 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final String DEFAULT_FIGURE_NAME = "Resources";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedResources";

	protected DslGenResourcesCreatorGem creatorGem;

	public DslGenResourcesCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenResourcesCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createResourcesSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenResourcesCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.RESOURCES);
	}

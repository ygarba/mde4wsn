...
public class DslGenFinalNodeNodeGem extends NoNameNodeGem {

	public DslGenFinalNodeNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenFinalNodeNodeGem(EObject subject, DiagramFacet diagram,

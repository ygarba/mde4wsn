...
public class DslGenTimingActionNodeGem extends SeparateNameContainerNodeGem {

	public DslGenTimingActionNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenTimingActionNodeGem(EObject subject, DiagramFacet diagram,

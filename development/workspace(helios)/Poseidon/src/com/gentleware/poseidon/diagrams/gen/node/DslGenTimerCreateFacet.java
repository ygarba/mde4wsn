...
import com.gentleware.poseidon.diagrams.gen.node.DslGenTimerCreatorGem;
...
public abstract class DslGenTimerCreateFacet extends CustomBaseNodeCreateFacet {
	public static final UDimension MINIMUM_SIZE = new UDimension(
			2.4 * ZGridLayer.DEFAULT_GRID_SPACING,
	...
	public static final String DEFAULT_FIGURE_NAME = "Timer";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedTimer";

	protected DslGenTimerCreatorGem creatorGem;

	public DslGenTimerCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenTimerCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createTimerSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenTimerCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.TIMER);
	}

...
import com.gentleware.poseidon.diagrams.gen.edge.DslGenTransitionCreatorGem;
...
public abstract class DslGenTransitionCreateFacet extends BaseArcCreateFacet {
	public static final String DEFAULT_FIGURE_NAME = "Transition";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedTransition";

	protected DslGenTransitionCreatorGem creatorGem;

	public DslGenTransitionCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenTransitionCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(DiagramFacet diagram,
		...
		final EObject target = (EObject) points.getNode2().getFigureFacet()
				.getSubject();
		return factory.createTransitionSemanticElement(source, target);
	}

	public String getFigureName() {
		return DslGenTransitionCreatorGem.NAME;
	}
	...
	public void initSourcesAndTargets() {
		...
		sources.add(DslGenElementRoles.STATE);
		sources.add(DslGenElementRoles.INITIALSTATE);

		final Set<String> targets = getTargets();
		targets.add(DslGenElementRoles.STATE);
		targets.add(DslGenElementRoles.FINALSTATE);
	}

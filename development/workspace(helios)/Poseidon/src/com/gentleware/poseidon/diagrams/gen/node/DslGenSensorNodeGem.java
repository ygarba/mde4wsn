...
public class DslGenSensorNodeGem extends SeparateNameContainerNodeGem {

	public DslGenSensorNodeGem(Color initialFillColor, PersistentFigure figure,
			String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenSensorNodeGem(EObject subject, DiagramFacet diagram,

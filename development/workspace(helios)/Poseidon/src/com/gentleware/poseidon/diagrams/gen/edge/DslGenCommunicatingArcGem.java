...
public class DslGenCommunicatingArcGem extends BaseArcGem {

	public DslGenCommunicatingArcGem(EObject subject, String figureName,
	...
	protected BasicArcAppearanceGem createBasicEdgeAppearanceFacet() {
		return new CustomBasicArcAppearanceFacet(fillColor, lineColor,
			...
			public ArcEndAppearanceFacet createSourceEndAppearanceFacet() {
				return new ClosedArrowArcEndAppearanceFacet(true);
			}

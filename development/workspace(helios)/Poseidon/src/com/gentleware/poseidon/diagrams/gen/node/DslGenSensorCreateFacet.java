...
import com.gentleware.poseidon.diagrams.gen.node.DslGenSensorCreatorGem;
...
public abstract class DslGenSensorCreateFacet extends CustomBaseNodeCreateFacet {
	public static final UDimension MINIMUM_SIZE = new UDimension(
			1.3 * ZGridLayer.DEFAULT_GRID_SPACING,
	...
	public static final String DEFAULT_FIGURE_NAME = "Sensor";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedSensor";

	protected DslGenSensorCreatorGem creatorGem;

	public DslGenSensorCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenSensorCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createSensorSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenSensorCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.SENSOR);
	}

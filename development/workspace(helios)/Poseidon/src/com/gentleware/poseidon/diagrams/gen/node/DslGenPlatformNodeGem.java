...
public class DslGenPlatformNodeGem extends BaseNodeGem {

	public DslGenPlatformNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenPlatformNodeGem(EObject subject, DiagramFacet diagram,

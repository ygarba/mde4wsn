...
import com.gentleware.poseidon.diagrams.gen.node.DslGenParametersCreatorGem;
...
public abstract class DslGenParametersCreateFacet extends
		CustomBaseNodeCreateFacet {
	public static final UDimension MINIMUM_SIZE = new UDimension(
			3.1 * ZGridLayer.DEFAULT_GRID_SPACING,
			2.2 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final UDimension DEFAULT_SIZE = new UDimension(
			3.1 * ZGridLayer.DEFAULT_GRID_SPACING,
			2.2 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final String DEFAULT_FIGURE_NAME = "Parameters";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedParameters";

	protected DslGenParametersCreatorGem creatorGem;

	public DslGenParametersCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenParametersCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createParametersSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenParametersCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.PARAMETERS);
	}

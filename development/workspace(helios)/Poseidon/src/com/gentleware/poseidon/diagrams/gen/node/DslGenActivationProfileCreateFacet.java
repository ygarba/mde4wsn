...
import com.gentleware.poseidon.diagrams.gen.node.DslGenActivationProfileCreatorGem;
...
public abstract class DslGenActivationProfileCreateFacet extends
		CustomBaseNodeCreateFacet {
	public static final UDimension MINIMUM_SIZE = new UDimension(
			3.7 * ZGridLayer.DEFAULT_GRID_SPACING,
			2.9 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final UDimension DEFAULT_SIZE = new UDimension(
			3.7 * ZGridLayer.DEFAULT_GRID_SPACING,
			2.9 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final String DEFAULT_FIGURE_NAME = "ActivationProfile";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedActivationProfile";

	protected DslGenActivationProfileCreatorGem creatorGem;

	public DslGenActivationProfileCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenActivationProfileCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createActivationProfileSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenActivationProfileCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.ACTIVATIONPROFILE);
	}

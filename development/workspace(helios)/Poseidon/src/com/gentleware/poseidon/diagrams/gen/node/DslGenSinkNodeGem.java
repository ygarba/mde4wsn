...
public class DslGenSinkNodeGem extends SeparateNameContainerNodeGem {

	public DslGenSinkNodeGem(Color initialFillColor, PersistentFigure figure,
			String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenSinkNodeGem(EObject subject, DiagramFacet diagram,

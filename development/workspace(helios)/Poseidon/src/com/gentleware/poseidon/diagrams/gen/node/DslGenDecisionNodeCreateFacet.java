...
import com.gentleware.poseidon.diagrams.gen.node.DslGenDecisionNodeCreatorGem;
...
public abstract class DslGenDecisionNodeCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "DecisionNode";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedDecisionNode";

	protected DslGenDecisionNodeCreatorGem creatorGem;

	public DslGenDecisionNodeCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenDecisionNodeCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createDecisionNodeSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenDecisionNodeCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.DECISIONNODE);
	}

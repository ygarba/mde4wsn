...
public class DslGenActuatorNodeGem extends SeparateNameContainerNodeGem {

	public DslGenActuatorNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenActuatorNodeGem(EObject subject, DiagramFacet diagram,

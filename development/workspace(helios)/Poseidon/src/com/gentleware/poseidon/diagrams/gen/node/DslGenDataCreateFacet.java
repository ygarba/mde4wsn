...
import com.gentleware.poseidon.diagrams.gen.node.DslGenDataCreatorGem;
...
public abstract class DslGenDataCreateFacet extends CustomBaseNodeCreateFacet {
	public static final UDimension MINIMUM_SIZE = new UDimension(
			5 * ZGridLayer.DEFAULT_GRID_SPACING,
			4 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final UDimension DEFAULT_SIZE = new UDimension(
			5 * ZGridLayer.DEFAULT_GRID_SPACING,
			4 * ZGridLayer.DEFAULT_GRID_SPACING);

	public static final String DEFAULT_FIGURE_NAME = "Data";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedData";

	protected DslGenDataCreatorGem creatorGem;

	public DslGenDataCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenDataCreatorGem creatorGem) {
	...
	public Object createFigure(Object subject, DiagramFacet diagram,
		...
		if (containerFacet != null) {
			containerFacet.getContentRoles().add(DslGenElementRoles.VARIABLE);
			containerFacet.getCompartmentContentRoles().add(
					DslGenElementRoles.VARIABLE);
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createDataSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenDataCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.DATA);
	}

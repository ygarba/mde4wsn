...
public class DslGenGetNodeActionNodeGem extends SeparateNameContainerNodeGem {

	public DslGenGetNodeActionNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenGetNodeActionNodeGem(EObject subject, DiagramFacet diagram,

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenPlatformSlotCreatorGem;
...
public abstract class DslGenPlatformSlotCreateFacet extends
		CustomBaseNodeCreateFacet {
	public static final UDimension MINIMUM_SIZE = new UDimension(
			12 * ZGridLayer.DEFAULT_GRID_SPACING,
	...
	public static final String DEFAULT_FIGURE_NAME = "PlatformSlot";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedPlatformSlot";

	protected DslGenPlatformSlotCreatorGem creatorGem;

	public DslGenPlatformSlotCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenPlatformSlotCreatorGem creatorGem) {
	...
	public Object createFigure(Object subject, DiagramFacet diagram,
		...
		if (containerFacet != null) {
			containerFacet.getContentRoles().add(DslGenElementRoles.PARAMETERS);

			containerFacet.getContentRoles().add(DslGenElementRoles.RUNTIME);

			containerFacet.getContentRoles().add(DslGenElementRoles.RESOURCES);

			containerFacet.getContentRoles().add(DslGenElementRoles.BATTERY);

			containerFacet.getContentRoles().add(DslGenElementRoles.ACTIVITY);
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createPlatformSlotSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenPlatformSlotCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.PLATFORMSLOT);
	}

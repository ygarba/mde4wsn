...
public class DslGenInitialStateNodeGem extends NoNameNodeGem {

	public DslGenInitialStateNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenInitialStateNodeGem(EObject subject, DiagramFacet diagram,

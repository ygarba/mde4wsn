...
import com.gentleware.poseidon.diagrams.gen.node.DslGenActuatingActionCreatorGem;
...
public abstract class DslGenActuatingActionCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "ActuatingAction";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedActuatingAction";

	protected DslGenActuatingActionCreatorGem creatorGem;

	public DslGenActuatingActionCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenActuatingActionCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createActuatingActionSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenActuatingActionCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.ACTUATINGACTION);
	}

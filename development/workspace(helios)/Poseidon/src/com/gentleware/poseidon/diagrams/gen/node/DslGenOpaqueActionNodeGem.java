...
public class DslGenOpaqueActionNodeGem extends SeparateNameContainerNodeGem {

	public DslGenOpaqueActionNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenOpaqueActionNodeGem(EObject subject, DiagramFacet diagram,

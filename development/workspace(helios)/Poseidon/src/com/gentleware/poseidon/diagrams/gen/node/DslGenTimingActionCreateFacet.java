...
import com.gentleware.poseidon.diagrams.gen.node.DslGenTimingActionCreatorGem;
...
public abstract class DslGenTimingActionCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "TimingAction";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedTimingAction";

	protected DslGenTimingActionCreatorGem creatorGem;

	public DslGenTimingActionCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenTimingActionCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createTimingActionSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenTimingActionCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.TIMINGACTION);
	}

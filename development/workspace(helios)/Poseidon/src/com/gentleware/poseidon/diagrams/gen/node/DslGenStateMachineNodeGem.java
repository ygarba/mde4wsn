...
public class DslGenStateMachineNodeGem extends BaseNodeGem {

	public DslGenStateMachineNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenStateMachineNodeGem(EObject subject, DiagramFacet diagram,

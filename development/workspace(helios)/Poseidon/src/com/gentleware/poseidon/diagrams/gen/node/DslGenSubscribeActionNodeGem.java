...
public class DslGenSubscribeActionNodeGem extends SeparateNameContainerNodeGem {

	public DslGenSubscribeActionNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenSubscribeActionNodeGem(EObject subject, DiagramFacet diagram,

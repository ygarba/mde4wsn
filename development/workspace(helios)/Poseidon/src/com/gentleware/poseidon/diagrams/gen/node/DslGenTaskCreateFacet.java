...
import com.gentleware.poseidon.diagrams.gen.node.DslGenTaskCreatorGem;
...
public abstract class DslGenTaskCreateFacet extends CustomBaseNodeCreateFacet {
	...
	public static final String DEFAULT_FIGURE_NAME = "Task";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedTask";

	protected DslGenTaskCreatorGem creatorGem;

	public DslGenTaskCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenTaskCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createTaskSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenTaskCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.TASK);
	}

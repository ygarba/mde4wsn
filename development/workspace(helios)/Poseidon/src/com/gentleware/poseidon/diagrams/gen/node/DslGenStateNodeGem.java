...
public class DslGenStateNodeGem extends BaseNodeGem {

	public DslGenStateNodeGem(Color initialFillColor, PersistentFigure figure,
			String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenStateNodeGem(EObject subject, DiagramFacet diagram,

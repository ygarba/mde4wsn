...
import com.gentleware.poseidon.diagrams.gen.node.DslGenInitialNodeCreatorGem;
...
public abstract class DslGenInitialNodeCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "InitialNode";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedInitialNode";

	protected DslGenInitialNodeCreatorGem creatorGem;

	public DslGenInitialNodeCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenInitialNodeCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createInitialNodeSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenInitialNodeCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.INITIALNODE);
	}

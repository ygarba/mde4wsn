...
public class DslGenTimerNodeGem extends SeparateNameContainerNodeGem {

	public DslGenTimerNodeGem(Color initialFillColor, PersistentFigure figure,
			String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenTimerNodeGem(EObject subject, DiagramFacet diagram,

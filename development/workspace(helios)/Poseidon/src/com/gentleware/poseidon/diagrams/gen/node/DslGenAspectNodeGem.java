...
public class DslGenAspectNodeGem extends BaseNodeGem {

	public DslGenAspectNodeGem(Color initialFillColor, PersistentFigure figure,
			String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenAspectNodeGem(EObject subject, DiagramFacet diagram,

...
public class DslGenEventNodeGem extends SeparateNameContainerNodeGem {

	public DslGenEventNodeGem(Color initialFillColor, PersistentFigure figure,
			String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenEventNodeGem(EObject subject, DiagramFacet diagram,
	...
	public NodeAppearanceFacet createBasicNodeAppearanceFacet() {
		return new SeparateNameUnderNodeAppearanceFacet(initialFillColor,
			...
			public ShapeAppearanceFacet createShapeAppearanceFacet() {
				return new RhombusShapeAppearanceFacet();
			}
		};
	}

...
public class DslGenMergeNodeNodeGem extends NoNameNodeGem {

	public DslGenMergeNodeNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenMergeNodeNodeGem(EObject subject, DiagramFacet diagram,

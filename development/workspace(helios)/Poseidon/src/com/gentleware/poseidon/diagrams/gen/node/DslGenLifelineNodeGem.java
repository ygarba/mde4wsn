...
public class DslGenLifelineNodeGem extends SeparateNameContainerNodeGem {

	public DslGenLifelineNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenLifelineNodeGem(EObject subject, DiagramFacet diagram,

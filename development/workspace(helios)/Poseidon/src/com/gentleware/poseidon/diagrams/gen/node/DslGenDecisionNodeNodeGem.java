...
public class DslGenDecisionNodeNodeGem extends NoNameNodeGem {

	public DslGenDecisionNodeNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenDecisionNodeNodeGem(EObject subject, DiagramFacet diagram,

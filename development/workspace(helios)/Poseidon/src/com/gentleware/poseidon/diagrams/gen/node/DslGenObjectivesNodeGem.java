...
public class DslGenObjectivesNodeGem extends SeparateNameContainerNodeGem {

	public DslGenObjectivesNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenObjectivesNodeGem(EObject subject, DiagramFacet diagram,

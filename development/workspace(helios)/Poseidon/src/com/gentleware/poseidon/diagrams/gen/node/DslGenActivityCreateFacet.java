...
import com.gentleware.poseidon.diagrams.gen.node.DslGenActivityCreatorGem;
...
public abstract class DslGenActivityCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "Activity";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedActivity";

	protected DslGenActivityCreatorGem creatorGem;

	public DslGenActivityCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenActivityCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createActivitySemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenActivityCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.ACTIVITY);
	}

...
public class DslGenActivationProfileNodeGem extends
		SeparateNameContainerNodeGem {

	public DslGenActivationProfileNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenActivationProfileNodeGem(EObject subject,

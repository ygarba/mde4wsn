...
import com.gentleware.poseidon.diagrams.gen.node.DslGenFinalNodeCreatorGem;
...
public abstract class DslGenFinalNodeCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "FinalNode";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedFinalNode";

	protected DslGenFinalNodeCreatorGem creatorGem;

	public DslGenFinalNodeCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenFinalNodeCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createFinalNodeSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenFinalNodeCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.FINALNODE);
	}

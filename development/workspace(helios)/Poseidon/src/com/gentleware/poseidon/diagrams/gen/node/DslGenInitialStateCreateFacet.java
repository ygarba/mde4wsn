...
import com.gentleware.poseidon.diagrams.gen.node.DslGenInitialStateCreatorGem;
...
public abstract class DslGenInitialStateCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "InitialState";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedInitialState";

	protected DslGenInitialStateCreatorGem creatorGem;

	public DslGenInitialStateCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenInitialStateCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createInitialStateSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenInitialStateCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.INITIALSTATE);
	}

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenUpdatePoolActionCreatorGem;
...
public abstract class DslGenUpdatePoolActionCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "UpdatePoolAction";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedUpdatePoolAction";

	protected DslGenUpdatePoolActionCreatorGem creatorGem;

	public DslGenUpdatePoolActionCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenUpdatePoolActionCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createUpdatePoolActionSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenUpdatePoolActionCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.UPDATEPOOLACTION);
	}

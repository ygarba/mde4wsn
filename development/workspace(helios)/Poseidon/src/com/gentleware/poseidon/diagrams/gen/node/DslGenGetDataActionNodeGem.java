...
public class DslGenGetDataActionNodeGem extends SeparateNameContainerNodeGem {

	public DslGenGetDataActionNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenGetDataActionNodeGem(EObject subject, DiagramFacet diagram,

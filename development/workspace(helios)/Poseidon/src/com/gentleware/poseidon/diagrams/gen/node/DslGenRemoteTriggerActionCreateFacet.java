...
import com.gentleware.poseidon.diagrams.gen.node.DslGenRemoteTriggerActionCreatorGem;
...
public abstract class DslGenRemoteTriggerActionCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "RemoteTriggerAction";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedRemoteTriggerAction";

	protected DslGenRemoteTriggerActionCreatorGem creatorGem;

	public DslGenRemoteTriggerActionCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenRemoteTriggerActionCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createRemoteTriggerActionSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenRemoteTriggerActionCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.REMOTETRIGGERACTION);
	}

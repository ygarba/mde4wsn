...
public class DslGenUpdatePoolActionNodeGem extends SeparateNameContainerNodeGem {

	public DslGenUpdatePoolActionNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenUpdatePoolActionNodeGem(EObject subject, DiagramFacet diagram,

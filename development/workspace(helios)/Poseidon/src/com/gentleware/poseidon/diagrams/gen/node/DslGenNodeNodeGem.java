...
public class DslGenNodeNodeGem extends SeparateNameContainerNodeGem {

	public DslGenNodeNodeGem(Color initialFillColor, PersistentFigure figure,
			String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenNodeNodeGem(EObject subject, DiagramFacet diagram,

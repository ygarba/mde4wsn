...
import com.gentleware.poseidon.diagrams.gen.node.DslGenOpaqueActionCreatorGem;
...
public abstract class DslGenOpaqueActionCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "OpaqueAction";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedOpaqueAction";

	protected DslGenOpaqueActionCreatorGem creatorGem;

	public DslGenOpaqueActionCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenOpaqueActionCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createOpaqueActionSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenOpaqueActionCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.OPAQUEACTION);
	}

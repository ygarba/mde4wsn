...
public class DslGenTaskNodeGem extends SeparateNameContainerNodeGem {

	public DslGenTaskNodeGem(Color initialFillColor, PersistentFigure figure,
			String figureName) {
		super(initialFillColor, figure, figureName, true);
	}

	public DslGenTaskNodeGem(EObject subject, DiagramFacet diagram,

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenAspectCreatorGem;
...
public abstract class DslGenAspectCreateFacet extends CustomBaseNodeCreateFacet {
	...
	public static final String DEFAULT_FIGURE_NAME = "Aspect";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedAspect";

	protected DslGenAspectCreatorGem creatorGem;

	public DslGenAspectCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenAspectCreatorGem creatorGem) {
	...
	public Object createFigure(Object subject, DiagramFacet diagram,
		...
		if (containerFacet != null) {
			containerFacet.getContentRoles().add(DslGenElementRoles.POINTCUT);

			containerFacet.getContentRoles().add(DslGenElementRoles.ADVICE);
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createAspectSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenAspectCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.ASPECT);
	}

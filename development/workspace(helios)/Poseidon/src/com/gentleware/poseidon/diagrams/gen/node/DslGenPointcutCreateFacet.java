...
import com.gentleware.poseidon.diagrams.gen.node.DslGenPointcutCreatorGem;
...
public abstract class DslGenPointcutCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "Pointcut";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedPointcut";

	protected DslGenPointcutCreatorGem creatorGem;

	public DslGenPointcutCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenPointcutCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createPointcutSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenPointcutCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.POINTCUT);
	}

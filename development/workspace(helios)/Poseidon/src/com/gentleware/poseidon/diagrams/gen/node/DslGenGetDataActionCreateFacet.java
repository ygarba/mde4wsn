...
import com.gentleware.poseidon.diagrams.gen.node.DslGenGetDataActionCreatorGem;
...
public abstract class DslGenGetDataActionCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "GetDataAction";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedGetDataAction";

	protected DslGenGetDataActionCreatorGem creatorGem;

	public DslGenGetDataActionCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenGetDataActionCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createGetDataActionSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenGetDataActionCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.GETDATAACTION);
	}

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenObjectivesCreatorGem;
...
public abstract class DslGenObjectivesCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "Objectives";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedObjectives";

	protected DslGenObjectivesCreatorGem creatorGem;

	public DslGenObjectivesCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenObjectivesCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createObjectivesSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenObjectivesCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.OBJECTIVES);
	}

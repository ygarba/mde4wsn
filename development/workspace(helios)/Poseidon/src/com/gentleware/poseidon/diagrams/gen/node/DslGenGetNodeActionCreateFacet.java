...
import com.gentleware.poseidon.diagrams.gen.node.DslGenGetNodeActionCreatorGem;
...
public abstract class DslGenGetNodeActionCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "GetNodeAction";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedGetNodeAction";

	protected DslGenGetNodeActionCreatorGem creatorGem;

	public DslGenGetNodeActionCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenGetNodeActionCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createGetNodeActionSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenGetNodeActionCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.GETNODEACTION);
	}

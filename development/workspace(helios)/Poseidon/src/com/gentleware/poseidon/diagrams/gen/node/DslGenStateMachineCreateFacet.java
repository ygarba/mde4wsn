...
import com.gentleware.poseidon.diagrams.gen.node.DslGenStateMachineCreatorGem;
...
public abstract class DslGenStateMachineCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "StateMachine";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedStateMachine";

	protected DslGenStateMachineCreatorGem creatorGem;

	public DslGenStateMachineCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenStateMachineCreatorGem creatorGem) {
	...
	public Object createFigure(Object subject, DiagramFacet diagram,
		...
		if (containerFacet != null) {
			containerFacet.getContentRoles().add(DslGenElementRoles.STATE);

			containerFacet.getContentRoles().add(
					DslGenElementRoles.INITIALSTATE);

			containerFacet.getContentRoles().add(DslGenElementRoles.FINALSTATE);
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createStateMachineSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenStateMachineCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.STATEMACHINE);
	}

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenClusterCreatorGem;
...
public abstract class DslGenClusterCreateFacet extends
	...
	public static final String DEFAULT_FIGURE_NAME = "cluster";
	public static final String SEMANTIC_ELEMENT = "com.gentleware.poseidon.model.wrapper.WrappedCluster";

	protected DslGenClusterCreatorGem creatorGem;

	public DslGenClusterCreatorGem getCreatorGem() {
		return creatorGem;
	}

	public void setCreatorGem(DslGenClusterCreatorGem creatorGem) {
	...
	public EObject createSemanticElement(EObject owner,
		...
		DslGenSemanticElementFactory factory = DslGenSemanticElementFactory
				.getInstance();
		return factory.createClusterSemanticElement(owner);
	}

	public String getFigureName() {
		return DslGenClusterCreatorGem.NAME;
	}
	...
	public void initNodeRoles() {
		...
		roles.add(DslGenElementRoles.CLUSTER);
	}

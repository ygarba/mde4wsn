...
public class DslGenClusterNodeGem extends SeparateNameContainerNodeGem {

	public DslGenClusterNodeGem(Color initialFillColor,
			PersistentFigure figure, String figureName) {
		super(initialFillColor, figure, figureName, false);
	}

	public DslGenClusterNodeGem(EObject subject, DiagramFacet diagram,

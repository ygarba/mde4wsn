...
import com.gentleware.poseidon.diagrams.gen.node.DslGenAdviceNodeGem;


		public class AdviceNodeGem extends DslGenAdviceNodeGem {
		
			public AdviceNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public AdviceNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,

...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class ObjectivesCreateFacetImpl extends DslGenObjectivesCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new ObjectivesNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new ObjectivesNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

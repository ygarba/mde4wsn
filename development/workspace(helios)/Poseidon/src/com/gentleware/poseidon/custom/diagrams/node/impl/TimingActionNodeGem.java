...
import com.gentleware.poseidon.diagrams.gen.node.DslGenTimingActionNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class TimingActionNodeGem extends DslGenTimingActionNodeGem {
		
			public TimingActionNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public TimingActionNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				ZLabel zlabel = new ZLabel("Timing"); 

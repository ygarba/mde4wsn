...
import com.gentleware.poseidon.diagrams.gen.node.DslGenFinalNodeNodeGem;


		public class FinalNodeNodeGem extends DslGenFinalNodeNodeGem {
		
			public FinalNodeNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public FinalNodeNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,

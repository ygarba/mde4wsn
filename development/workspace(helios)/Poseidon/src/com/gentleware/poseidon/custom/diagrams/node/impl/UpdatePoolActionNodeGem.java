...
import com.gentleware.poseidon.diagrams.gen.node.DslGenUpdatePoolActionNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class UpdatePoolActionNodeGem extends DslGenUpdatePoolActionNodeGem {
		
			public UpdatePoolActionNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public UpdatePoolActionNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				ZLabel zlabel = new ZLabel("Update"); 

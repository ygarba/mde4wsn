...
import com.gentleware.poseidon.diagrams.gen.node.DslGenClusterHeadNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class ClusterHeadNodeGem extends DslGenClusterHeadNodeGem {
		
			public ClusterHeadNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public ClusterHeadNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,

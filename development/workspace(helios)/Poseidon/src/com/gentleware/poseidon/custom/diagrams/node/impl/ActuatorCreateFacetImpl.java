...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class ActuatorCreateFacetImpl extends DslGenActuatorCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new ActuatorNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new ActuatorNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

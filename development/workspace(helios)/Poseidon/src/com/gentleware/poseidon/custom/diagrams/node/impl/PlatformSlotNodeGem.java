...
import com.gentleware.poseidon.diagrams.gen.node.DslGenPlatformSlotNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class PlatformSlotNodeGem extends DslGenPlatformSlotNodeGem {
		
			public PlatformSlotNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public PlatformSlotNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/platformslot_24x25.png"));                      
				...
				ZLabel zlabel = new ZLabel("  Platform Slot"); 

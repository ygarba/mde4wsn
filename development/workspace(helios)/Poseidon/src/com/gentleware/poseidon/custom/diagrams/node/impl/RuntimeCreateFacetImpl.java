...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class RuntimeCreateFacetImpl extends DslGenRuntimeCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new RuntimeNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new RuntimeNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenSensorNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class SensorNodeGem extends DslGenSensorNodeGem {
		
			public SensorNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public SensorNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/sensor_25x80.png"));                      
				...
				ZLabel zlabel = new ZLabel("Sensor"); 

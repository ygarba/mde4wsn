...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class ActuatingActionCreateFacetImpl extends DslGenActuatingActionCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new ActuatingActionNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new ActuatingActionNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

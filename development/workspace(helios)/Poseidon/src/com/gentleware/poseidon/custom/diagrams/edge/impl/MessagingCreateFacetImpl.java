...
import com.gentleware.poseidon.idraw.foundation.persistence.PersistentProperties;
		...
		public class MessagingCreateFacetImpl extends DslGenMessagingCreateFacet {
			...
			public ArcGem createArcGem(Object subject, DiagramFacet diagram,
				...
				return new MessagingArcGem((EObject) subject, getFigureName(), extractFillColor(properties), false);
			}
	
			@Override
			public ArcGem createArcGem(DiagramFacet diagram, PersistentFigure figure, AbstractBasicArcGem gem) { 
				return new MessagingArcGem((EObject) figure.getSubject(), getFigureName(), extractFillColor(figure.getProperties()), true);
			}

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenDecisionNodeNodeGem;


		public class DecisionNodeNodeGem extends DslGenDecisionNodeNodeGem {
		
			public DecisionNodeNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public DecisionNodeNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,

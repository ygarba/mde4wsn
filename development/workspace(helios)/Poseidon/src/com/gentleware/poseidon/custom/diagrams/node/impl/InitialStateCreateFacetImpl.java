...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class InitialStateCreateFacetImpl extends DslGenInitialStateCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new InitialStateNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new InitialStateNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenNodeNodeGem;
		...
		public class NodeNodeGemBK extends DslGenNodeNodeGem {
		
			public NodeNodeGemBK(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public NodeNodeGemBK(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,

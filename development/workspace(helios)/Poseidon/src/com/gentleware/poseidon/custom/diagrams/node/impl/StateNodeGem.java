...
import com.gentleware.poseidon.diagrams.gen.node.DslGenStateNodeGem;


		public class StateNodeGem extends DslGenStateNodeGem {
		
			public StateNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public StateNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,

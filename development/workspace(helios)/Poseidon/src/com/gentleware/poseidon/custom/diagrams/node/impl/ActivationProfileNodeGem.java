...
import com.gentleware.poseidon.diagrams.gen.node.DslGenActivationProfileNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class ActivationProfileNodeGem extends DslGenActivationProfileNodeGem {
		
			public ActivationProfileNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public ActivationProfileNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/profile_60x60.png"));                      
				...
				ZLabel zlabel = new ZLabel("Profile"); 

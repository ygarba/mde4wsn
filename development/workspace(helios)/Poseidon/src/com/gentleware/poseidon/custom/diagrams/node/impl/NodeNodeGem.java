...
import com.gentleware.poseidon.diagrams.gen.node.DslGenNodeNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class NodeNodeGem extends DslGenNodeNodeGem {
		
			public NodeNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public NodeNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,

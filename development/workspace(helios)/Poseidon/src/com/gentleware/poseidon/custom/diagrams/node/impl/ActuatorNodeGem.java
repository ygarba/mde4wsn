...
import com.gentleware.poseidon.diagrams.gen.node.DslGenActuatorNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class ActuatorNodeGem extends DslGenActuatorNodeGem {
		
			public ActuatorNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public ActuatorNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/actuator_62x40.png"));                      
				...
				ZLabel zlabel = new ZLabel("Actuator"); 

...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class BatteryCreateFacetImpl extends DslGenBatteryCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new BatteryNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new BatteryNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

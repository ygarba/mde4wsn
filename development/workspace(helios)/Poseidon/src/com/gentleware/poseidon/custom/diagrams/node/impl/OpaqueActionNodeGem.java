...
import com.gentleware.poseidon.diagrams.gen.node.DslGenOpaqueActionNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class OpaqueActionNodeGem extends DslGenOpaqueActionNodeGem {
		
			public OpaqueActionNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public OpaqueActionNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				ZLabel zlabel = new ZLabel("Opaque"); 

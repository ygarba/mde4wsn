...
import com.gentleware.poseidon.diagrams.gen.node.DslGenPointcutNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class PointcutNodeGem extends DslGenPointcutNodeGem {
		
			public PointcutNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public PointcutNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/pointcut_62x39.png"));                      
				...
				ZLabel zlabel = new ZLabel("Pointcut"); 

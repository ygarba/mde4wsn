...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class ActivationProfileCreateFacetImpl extends DslGenActivationProfileCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new ActivationProfileNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new ActivationProfileNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

...
import com.gentleware.poseidon.diagrams.gen.node.DslGenTimerNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class TimerNodeGem extends DslGenTimerNodeGem {
		
			public TimerNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public TimerNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/timer_48x60.png"));                      
				...
				ZLabel zlabel = new ZLabel("Timer"); 
				zlabel.setTranslation(topLeft.getX(), topLeft.getY()-15);

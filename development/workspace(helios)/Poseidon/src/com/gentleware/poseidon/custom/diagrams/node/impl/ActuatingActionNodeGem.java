...
import com.gentleware.poseidon.diagrams.gen.node.DslGenActuatingActionNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class ActuatingActionNodeGem extends DslGenActuatingActionNodeGem {
		
			public ActuatingActionNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public ActuatingActionNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				ZLabel zlabel = new ZLabel("Actuating"); 

...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class GetNodeActionCreateFacetImpl extends DslGenGetNodeActionCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new GetNodeActionNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new GetNodeActionNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

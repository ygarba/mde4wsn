...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class ResourcesCreateFacetImpl extends DslGenResourcesCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new ResourcesNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new ResourcesNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

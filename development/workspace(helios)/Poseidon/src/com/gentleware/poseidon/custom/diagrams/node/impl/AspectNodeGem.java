...
import com.gentleware.poseidon.diagrams.gen.node.DslGenAspectNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class AspectNodeGem extends DslGenAspectNodeGem {
		
			public AspectNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public AspectNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/aspect_24x15.png"));                      
				...
				ZLabel zlabel = new ZLabel("  Aspect"); 

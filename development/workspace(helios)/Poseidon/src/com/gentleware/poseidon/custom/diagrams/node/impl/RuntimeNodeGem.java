...
import com.gentleware.poseidon.diagrams.gen.node.DslGenRuntimeNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class RuntimeNodeGem extends DslGenRuntimeNodeGem {
		
			public RuntimeNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public RuntimeNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/runtime_64x40.png"));                      
				...
				ZLabel zlabel = new ZLabel("Runtime"); 

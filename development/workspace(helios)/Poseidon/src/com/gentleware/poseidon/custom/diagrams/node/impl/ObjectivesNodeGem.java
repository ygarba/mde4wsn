...
import com.gentleware.poseidon.diagrams.gen.node.DslGenObjectivesNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class ObjectivesNodeGem extends DslGenObjectivesNodeGem {
		
			public ObjectivesNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public ObjectivesNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/objectives_60x60.png"));                      
				...
				ZLabel zlabel = new ZLabel("Objective"); 

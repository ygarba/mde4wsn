...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class UpdatePoolActionCreateFacetImpl extends DslGenUpdatePoolActionCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new UpdatePoolActionNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new UpdatePoolActionNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

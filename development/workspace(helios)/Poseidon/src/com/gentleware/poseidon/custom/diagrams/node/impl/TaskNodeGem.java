...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class TaskNodeGem extends DslGenTaskNodeGem {
		
			public TaskNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public TaskNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/gears_20x20.png"));                      

...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class RemoteTriggerActionCreateFacetImpl extends DslGenRemoteTriggerActionCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new RemoteTriggerActionNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new RemoteTriggerActionNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

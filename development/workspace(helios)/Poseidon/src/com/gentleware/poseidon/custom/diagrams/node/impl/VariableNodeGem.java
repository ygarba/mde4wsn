...
import com.gentleware.poseidon.diagrams.gen.node.DslGenVariableNodeGem;


		public class VariableNodeGem extends DslGenVariableNodeGem {
		
			public VariableNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public VariableNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,

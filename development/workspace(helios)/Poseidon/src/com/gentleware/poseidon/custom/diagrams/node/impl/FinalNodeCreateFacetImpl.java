...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class FinalNodeCreateFacetImpl extends DslGenFinalNodeCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new FinalNodeNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new FinalNodeNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

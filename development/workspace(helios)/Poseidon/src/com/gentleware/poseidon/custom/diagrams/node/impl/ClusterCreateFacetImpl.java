...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class ClusterCreateFacetImpl extends DslGenClusterCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new ClusterNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new ClusterNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

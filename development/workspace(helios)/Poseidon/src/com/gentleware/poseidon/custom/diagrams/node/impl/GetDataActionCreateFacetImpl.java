...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class GetDataActionCreateFacetImpl extends DslGenGetDataActionCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new GetDataActionNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new GetDataActionNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

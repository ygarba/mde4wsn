...
import com.gentleware.poseidon.diagrams.gen.node.DslGenParametersNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class ParametersNodeGem extends DslGenParametersNodeGem {
		
			public ParametersNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public ParametersNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/parameter_60x41.png"));                      
				...
				ZLabel zlabel = new ZLabel("Parameter"); 

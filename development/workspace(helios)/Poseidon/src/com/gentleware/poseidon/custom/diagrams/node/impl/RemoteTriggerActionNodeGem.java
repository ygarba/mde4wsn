...
import com.gentleware.poseidon.diagrams.gen.node.DslGenRemoteTriggerActionNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class RemoteTriggerActionNodeGem extends DslGenRemoteTriggerActionNodeGem {
		
			public RemoteTriggerActionNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public RemoteTriggerActionNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				ZLabel zlabel = new ZLabel("Trigger"); 

...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class ParametersCreateFacetImpl extends DslGenParametersCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new ParametersNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new ParametersNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

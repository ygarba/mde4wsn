...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class SensingActionCreateFacetImpl extends DslGenSensingActionCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new SensingActionNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new SensingActionNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

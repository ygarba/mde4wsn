...
import com.gentleware.poseidon.diagrams.gen.node.DslGenGetNodeActionNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class GetNodeActionNodeGem extends DslGenGetNodeActionNodeGem {
		
			public GetNodeActionNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public GetNodeActionNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				ZLabel zlabel = new ZLabel("Get Node"); 

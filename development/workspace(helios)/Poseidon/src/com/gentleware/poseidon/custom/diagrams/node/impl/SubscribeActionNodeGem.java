...
import com.gentleware.poseidon.diagrams.gen.node.DslGenSubscribeActionNodeGem;


		public class SubscribeActionNodeGem extends DslGenSubscribeActionNodeGem {
		
			public SubscribeActionNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public SubscribeActionNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,

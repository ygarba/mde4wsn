...
import com.gentleware.poseidon.diagrams.gen.node.DslGenResourcesNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class ResourcesNodeGem extends DslGenResourcesNodeGem {
		
			public ResourcesNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public ResourcesNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/resource_64x67.png"));                      
				...
				ZLabel zlabel = new ZLabel("Resource"); 

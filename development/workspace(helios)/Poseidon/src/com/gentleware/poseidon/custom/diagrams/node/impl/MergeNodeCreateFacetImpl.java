...
import com.gentleware.poseidon.idraw.nodefacilities.nodesupport.BasicNodeGem;
		...
		public class MergeNodeCreateFacetImpl extends DslGenMergeNodeCreateFacet {
			...
			public NodeGem createNodeGem(Object subject, DiagramFacet diagram,
				...
				return new MergeNodeNodeGem((EObject) subject, diagram,
			...
			public NodeGem createNodeGem(DiagramFacet diagram,
				...
				return new MergeNodeNodeGem(extractFillColor(figure.getProperties()), figure, getFigureName());
			}

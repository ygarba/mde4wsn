...
import com.gentleware.poseidon.diagrams.gen.node.DslGenClusterNodeGem;
...
import edu.umd.cs.jazz.component.ZShape;
		...
		public class ClusterNodeGem extends DslGenClusterNodeGem {
		
			public ClusterNodeGem(Color initialFillColor, PersistentFigure figure, String figureName) {
				super(initialFillColor, figure, figureName);
			}

			public ClusterNodeGem(EObject subject, DiagramFacet diagram, String figureId, Color initialFillColor,
			...
			public ZVisualComponent[] drawShapes(UBounds bounds) {
				...
				try {            
		            image = ImageIO.read(this.getClass().getResource("/cluster_25x15.png"));                      
				...
				ZLabel zlabel = new ZLabel("Cluster"); 

 ...
 * <ul>
 *   <li>{@link com.gentleware.poseidon.dsl.wsn.impl.ActivityEdgeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link com.gentleware.poseidon.dsl.wsn.impl.ActivityEdgeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityEdgeImpl extends EObjectImpl implements ActivityEdge {
	...
	protected EClass eStaticClass() {
		return USERPackage.Literals.ACTIVITY_EDGE;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, USERPackage.ACTIVITY_EDGE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(ActivityNode newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, USERPackage.ACTIVITY_EDGE__SOURCE, oldSource, source));
	}
	...
	public ActivityNode getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, USERPackage.ACTIVITY_EDGE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ActivityNode newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, USERPackage.ACTIVITY_EDGE__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case USERPackage.ACTIVITY_EDGE__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case USERPackage.ACTIVITY_EDGE__TARGET:

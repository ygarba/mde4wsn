...
/**
 * A sample validator interface for {@link com.gentleware.poseidon.dsl.wsn.Platform}.
...
public interface PlatformValidator {
	...
	boolean validateAspect(Aspect value);
	boolean validateSlot(PlatformSlot value);
}

 ...
 * <ul>
 *   <li>{@link com.gentleware.poseidon.dsl.wsn.impl.PointcutImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointcutImpl extends EObjectImpl implements Pointcut {
	...
	protected EClass eStaticClass() {
		return USERPackage.Literals.POINTCUT;
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, USERPackage.POINTCUT__EXPRESSION, oldExpression, expression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case USERPackage.POINTCUT__EXPRESSION:

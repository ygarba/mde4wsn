...
import com.gentleware.poseidon.dsl.wsn.impl.GetNodeActionImpl;
...
public class WrappedGetNodeActionImpl extends GetNodeActionImpl implements WrappedGetNodeAction {
	...
	protected WrappedGetNodeActionImpl() {
		super();
	...
	protected EClass eStaticClass() {
		return WrapperPackage.Literals.WRAPPED_GETNODEACTION;
	}
	...
	public void set__uuid(String new__uuid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__UUID, old__uuid, __uuid));
	}
	...
	public void setJ_deleted(int newJ_deleted) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__JDELETED, oldJ_deleted, j_deleted));
	}
	...
	public NotificationChain basicSetJ_diagramHolder(J_DiagramHolder newJ_diagramHolder, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__JDIAGRAM_HOLDER, oldJ_diagramHolder, newJ_diagramHolder);
	...
	public void setJ_diagramHolder(J_DiagramHolder newJ_diagramHolder) {
		if (newJ_diagramHolder != j_diagramHolder) {
			...
			if (j_diagramHolder != null)
				msgs = ((InternalEObject)j_diagramHolder).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WrapperPackage.WRAPPED_GETNODEACTION__JDIAGRAM_HOLDER, null, msgs);
			if (newJ_diagramHolder != null)
				msgs = ((InternalEObject)newJ_diagramHolder).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WrapperPackage.WRAPPED_GETNODEACTION__JDIAGRAM_HOLDER, null, msgs);
			msgs = basicSetJ_diagramHolder(newJ_diagramHolder, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__JDIAGRAM_HOLDER, newJ_diagramHolder, newJ_diagramHolder));
	}
	...
	public void set__readOnly(boolean new__readOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__READ_ONLY, old__readOnly, __readOnly));
	}
	...
	public void set__poseidonName(String new__poseidonName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_NAME, old__poseidonName, __poseidonName, !old__poseidonNameESet));
	}
	...
	public void unset__poseidonName() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_NAME, old__poseidonName, _POSEIDON_NAME_EDEFAULT, old__poseidonNameESet));
	}
	...
	public void set__poseidonNamespace(boolean new__poseidonNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_NAMESPACE, old__poseidonNamespace, __poseidonNamespace));
	}

	public EList<EObject> get__ownedMember() {
		if (__ownedMember == null) {
			__ownedMember = new EObjectContainmentEList<EObject>(EObject.class, this, WrapperPackage.WRAPPED_GETNODEACTION__OWNED_MEMBER);
		}
	...
	public EObject get__source() {
		if (__source != null && __source.eIsProxy()) {
			...
			if (__source != old__source) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WrapperPackage.WRAPPED_GETNODEACTION__SOURCE, old__source, __source));
			}
		}
		return __source;
	}
	...
	public void set__source(EObject new__source) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__SOURCE, old__source, __source));
	}
	...
	public EObject get__target() {
		if (__target != null && __target.eIsProxy()) {
			...
			if (__target != old__target) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WrapperPackage.WRAPPED_GETNODEACTION__TARGET, old__target, __target));
			}
		}
		return __target;
	}
	...
	public void set__target(EObject new__target) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__TARGET, old__target, __target));
	}
	...
	public void set__poseidonEdge(boolean new__poseidonEdge) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_EDGE, old__poseidonEdge, __poseidonEdge));
	}
	...
	public void set__poseidonRole(String new__poseidonRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_ROLE, old__poseidonRole, __poseidonRole));
	}	
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__JDIAGRAM_HOLDER) {
			return basicSetJ_diagramHolder(null, msgs);
		}
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__OWNED_MEMBER) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__UUID) {
			return get__uuid();
		}	
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__JDELETED) {
			return getJ_deleted();
		}
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__JDIAGRAM_HOLDER) {
			return getJ_diagramHolder();
		}
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__READ_ONLY) {
			return is__readOnly();
		}	
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_NAME) {
			return get__poseidonName();
		}
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_NAMESPACE) {
			return is__poseidonNamespace();
		}
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__OWNED_MEMBER) {
			return get__ownedMember();
		}	
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__SOURCE) {
			if (resolve) return get__source();
			return basicGet__source();
		}	
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__TARGET) {
			if (resolve) return get__target();
			return basicGet__target();
		}
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_EDGE) {
			return is__poseidonEdge();
		}
		if (featureID == WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_ROLE) {					
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MetamodelElementWrapper.class) {
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__UUID) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__UUID;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__JDELETED) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__JDELETED;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__JDIAGRAM_HOLDER) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__JDIAGRAM_HOLDER;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__READ_ONLY) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__READ_ONLY;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_NAME) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__POSEIDON_NAME;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_NAMESPACE) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__POSEIDON_NAMESPACE;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__OWNED_MEMBER) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__OWNED_MEMBER;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__SOURCE) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__SOURCE;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__TARGET) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__TARGET;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_EDGE) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__POSEIDON_EDGE;
			if (derivedFeatureID == WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_ROLE) return DSLPackage.METAMODEL_ELEMENT_WRAPPER__POSEIDON_ROLE;			
			return -1;			
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MetamodelElementWrapper.class) {
			switch (baseFeatureID) {
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__UUID: return WrapperPackage.WRAPPED_GETNODEACTION__UUID;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__JDELETED: return WrapperPackage.WRAPPED_GETNODEACTION__JDELETED;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__JDIAGRAM_HOLDER: return WrapperPackage.WRAPPED_GETNODEACTION__JDIAGRAM_HOLDER;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__READ_ONLY: return WrapperPackage.WRAPPED_GETNODEACTION__READ_ONLY;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__POSEIDON_NAME: return WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_NAME;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__POSEIDON_NAMESPACE: return WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_NAMESPACE;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__OWNED_MEMBER: return WrapperPackage.WRAPPED_GETNODEACTION__OWNED_MEMBER;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__SOURCE: return WrapperPackage.WRAPPED_GETNODEACTION__SOURCE;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__TARGET: return WrapperPackage.WRAPPED_GETNODEACTION__TARGET;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__POSEIDON_EDGE: return WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_EDGE;
				case DSLPackage.METAMODEL_ELEMENT_WRAPPER__POSEIDON_ROLE: return WrapperPackage.WRAPPED_GETNODEACTION__POSEIDON_ROLE;
				default: return -1;
			}
		}
